      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.05)] mb-8">
        <div className="py-6 px-8">
          ...
          <p className="text-gray-700 mb-4">
            Add a new project to the OSS (Open Source Software) directory which is used by OLI. The project from will generate a YAML file that can be added to the OSS repo via a GitHub pull request.
          </p>
          <Link 
