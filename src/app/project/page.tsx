    ...
    <main className="max-w-3xl mx-auto p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.05)] mb-8">
        <div className="py-6 px-8">
          ...
          <p className="text-gray-700 mb-4">
            Add a new project to the OSS (Open Source Software) directory which is used by OLI. The project information will be generated as a YAML file that can be downloaded.
          </p>
          <Link 
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.05)]">
        <div className="flex justify-between items-center pt-6 pb-4 px-8">
          <h2 className="text-2xl font-bold text-gray-900">Project Information Form</h2>
        </div>
        <AddProjectForm />
      </div>
    </main>
