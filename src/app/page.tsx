...
const HomePage: FC = () => {
  ...
  useEffect(() => {
    ...
    function findProductsSection(text) {
    ...
    <div className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Discover projects leveraging the Open Labels Initiative
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {loading ? (
            ...
            <>
              ...
              >
                <div className="h-48 bg-white relative border border-gray-200">
                  <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900">Add Your Project</h3>
                </div>
              </a>
            </>
          )}
